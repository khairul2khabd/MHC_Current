...
<form class="kha-aero" id="patientRegistrationForm" method="POST">
    <h1>Patient Registration Form</h1>
    <b>Patient Information</b>
    <table cellspacing="0">
        <tr>
            <td valign="top" class="cell"><b>Patient Name <span style="color: red">*</span></b>
            </td>
            ...
            <td class="cell"><b>ID Number <span style="color: red">* &nbsp;&nbsp; <input readonly name="patient.identifier" style="border: none; width: 250px; background:none;" />
                </b>
            </td>
