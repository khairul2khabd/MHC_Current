...
public class IpdServiceImpl extends BaseOpenmrsService implements IpdService {
    ...
    public IpdPatientIntake saveIpdPatientIntake(IpdPatientIntake ipdPatientIntake)
            throws APIException {
        return dao.saveIpdPatientIntake(ipdPatientIntake);
    }

    public List<IpdPatientIntake> getIpdPatientIntake(
            Integer patientId, Integer patientAdmissionLogId)
            throws APIException {
        return dao.getIpdPatientIntake(patientId, patientAdmissionLogId);
    }

    public List<OpdDrugOrder> getOpdDrugOrderByPatientEncounterId(
            Integer pateintId ) throws APIException {
         return dao.getOpdDrugOrderByPatientEncounterId(pateintId);
    }
    
    /// New for queue maintain
    
    public IpdPatientAdmission getAdmissionByPatientId(Integer patientId)
            throws APIException {
        return dao.getAdmissionByPatientId(patientId);
    }
    ...
    public IpdPatientAdmittedQueueLog saveIpdPatientAdmittedQueueLog(IpdPatientAdmittedQueueLog admittedqueuelog) throws APIException {
        ...
        return dao.saveIpdPatientAdmittedQueueLog(admittedqueuelog);
    }

    public IpdPatientAdmittedQueueLog getIpdpatientAdmittedQueueLogNew(Integer enconterId) throws APIException {
        return dao.getIpdpatientAdmittedQueueLogNew(enconterId);
      }

    public void removeIpdPatientAdmittedQueueLogNew(IpdPatientAdmittedQueueLog admittedqueuelog) throws APIException {
        dao.removeIpdPatientAdmittedQueueLogNew(admittedqueuelog);
    ///      dao.removeIpdPatientAdmittedQueueLog(admittedqueuelog);
    }
