...
<form class="form-rep-view" method="get" action="comResult.htm" id="commissionCalForm" onsubmit="return validate()" >
    ...
    <c:if test="${not empty diaComCal}">
        <div  style="margin-left:100px;">
            ...
            <span style="font-size:16px; padding-left:50px; font-weight:bold; color:#000;">Total Payable Amount : &nbsp; </span> <input type="value" id="dcomm" name="dcomm"  readOnly="true" 
            ...
            <span style="font-size:16px; padding-left: 0px; font-weight:bold; color:#000;">Doctor Commission : &emsp; </span> <input type="value" id="docNet" name="docNet"  readOnly="true"
        ...
        <input type="button" class="bs" value="Print" onclick="printDiv3();" /> 
    </c:if>
