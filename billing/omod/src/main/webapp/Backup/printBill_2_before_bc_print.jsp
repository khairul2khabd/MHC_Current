...
<form method="POST" action="billprint.htm" id="billPrint">
    ...
    <!--
        <div id="barDiv"  style="width: 200px; height:80px; display:  ; margin-top:10px;  ">
    <c:forEach var="sol" items="${tmn}" varStatus="index">
          <img src="${pageContext.request.contextPath}/barcode/${sol.sampleId}.png" height="43" />  <br> 
                     <img src="${pageContext.request.contextPath}/barcode/${patient.patientId}.png" />
        <tr> 
            <td align="left" ><b style="font-size:12px;">${sol.name}</b></td> <br>
        </tr>
    </c:forEach>	
</div> -->
    ...
    <div id="barDiv"  style="width: 200px; height:80px; display:none; margin-top:10px;  ">
        <c:forEach var="sol" items="${tmn}" varStatus="index">
           <!-- <img src="${pageContext.request.contextPath}/barcode/${sol.sampleId}.png" /> <br> <br> -->
            <img style="left:-5px;" src="${pageContext.request.contextPath}/barcode/${patient.patientId}.png" /> <br>
            <tr> 
                <td align="left" ><b style="font-size:10px;">${sol.name}</b></td> <br><br>
            </tr>
        </c:forEach>	
    </div>
</form>
...
<script>
    function barDivPrint() {
        var printer = window.open('left=0', 'top=0', 'width=200,height=100');
