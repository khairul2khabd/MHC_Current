...
<div style="border-bottom: 1px solid black; padding-bottom:5px; margin-bottom:10px;">
    <ul id="menu">
        ...
        <openmrs:hasPrivilege privilege="Manage Laboratory Confidential Test">
            <li id="AddEditLabDoctor">
                <a href="pathologydoctor.form" target="_blank">Add/Edit Lab Doctor</a>
            </li>
        </openmrs:hasPrivilege>
    </ul>
</div>
...
<script type="text/javascript">
    ...
    } else if (contain(url, "pathologydoctor.form")) {
        activate("AddEditLabDoctor");
    }
