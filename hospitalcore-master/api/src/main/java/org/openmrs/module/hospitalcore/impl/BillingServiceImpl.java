			...
			for (ConceptAnswer ca : answers) {
				if (ca.getConcept() == con) {
					...
					if (ca.getAnswerConcept().getAnswers() == null || ca.getAnswerConcept().getAnswers().size() == 0
						...
						if (s != null) {
							rs += "<span style='vertical-align:middle; float:right;'>";
							rs += "&nbsp;&nbsp;<input onblur='updatePrice(this)' title="+"Price"+" type='text' class='priceField' id='" + id
							        + "_price' name='" + id + "_price' value=" + s.getPrice() + ">";
							
                                                        rs+= "&nbsp;&nbsp;<input onblur='updatePrice(this)' title="+"Search Id"+"  type='text' class='priceField' id='" + id
							        + "_shortname' name='" + id + "_shortname' value=" + s.getShortName() + ">";
                                                        
                                                        rs+= "&nbsp;&nbsp;<input onblur='updatePrice(this)'  type='text' title="+"Percentage"+" class='priceField' id='" + id
							        + "_commission' name='" + id + "_commission' value=" + s.getCommission() + ">";
							...
							rs += "<input onblur='updatePrice(this)' type='text' class='priceField' id='" + id
							        + "_price' name='" + id + "_price' value=''>";
                                                        ...
                                                        rs += "<input onblur='updatePrice(this)' type='text' class='priceField' id='" + id
							        + "_shortname' name='" + id + "_shortname' value=''>";
                                                        rs+= "&nbsp;&nbsp;<input onblur='updatePrice(this)'  type='text' title="+"Commission"+" class='priceField' id='" + id
							        + "_commission' name='" + id + "_commission' value=''>";
						}
					} else {
						rs += "<li>";
						rs += "<input   name='cons' type='checkbox'  value='" + id + "' >";
