 ...
 *
 * author: ghanshyam date: 10-june-2013 issue no: #1847
 *
 */
...
public class IpdPatientVitalStatistics {
    ...
    private String respirationRate; // for nikdu
    private String urineTaken; // for nikdu
    private String stoolTaken; // for nikdu
    ...
    public String getUrineTaken() {
        return urineTaken;
    }

    public void setUrineTaken(String urineTaken) {
        this.urineTaken = urineTaken;
    }

    public String getStoolTaken() {
        return stoolTaken;
    }

    public void setStoolTaken(String stoolTaken) {
        this.stoolTaken = stoolTaken;
    }
