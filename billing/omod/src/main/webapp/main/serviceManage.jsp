...
<br>
<form method="POST" class="kha-css" id="billMapping" onsubmit="return false">
    ...
    <div>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <input type="button" class="bu" id="priceForm" name="subm" value="Save"
               onclick="submitForm()" />
    </div>
    <br>
</form>
        ...
        jQuery("input[type='checkbox']:checked").each(function() {
            ...
            if (jQuery(id).length > 0) {
                if (!validPrice(jQuery(id).val())) {
                    ...
                    shortNames += "\n" + jQuery("#" + jQuery(this).val() + "_shortName").val();
                }
            }
        });
        if (!valid) {
...
<link type="text/css" rel="stylesheet"
	href="${pageContext.request.contextPath}/moduleResources/billing/scripts/jquery/css/kha-billservice.css"/>
