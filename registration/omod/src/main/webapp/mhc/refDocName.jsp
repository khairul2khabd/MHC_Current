...
<div class="div1">
    <form method="post" class="abc" id="refDoctor" action="refDoc.htm" onsubmit="return validate()">
        <h1>Add / Edit Doctor Name</h1>
        <br>
        <table width="70%">
    ...
    <script>
        function myFunction(id) {
            var url = "editRefDoc.htm?id=" + id + "&KeepThis=true&TB_iframe=true&width=800&height=500";
