...
<tr><b>
    ...
    <td> RMP   <input placeholder="Click/Enter Here....." type="text"
                      class="ui-autocomplete-input ui-widget-content ui-corner-all"
    ...
    <input class="button" type="button" style="float: center;" value="Add/Edit RMP Name" onclick="window.open('refRmp.htm?', '_blank');")/>
