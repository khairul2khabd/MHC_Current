...
public class HibernatePatientDashboardDAO implements PatientDashboardDAO {
    ...
    public OpddrugorderNew  saveDrugOrderOpdNew(OpddrugorderNew  opdDrugOrderNew) throws DAOException {
        sessionFactory.getCurrentSession().saveOrUpdate(opdDrugOrderNew);
    return opdDrugOrderNew;
    }
