...
public class HibernateHospitalCoreDAO implements HospitalCoreDAO {
	...
	public java.util.Date getLastVisitTime(int patientID) {
		...
		criteria.add(Restrictions.eq("patientId", patientID));
                ...
                //criteria.add(Expression.between("encounterType", 1,6));
    ...
    //public DiaPatientNew getPatientById(Integer patientId) throws DAOException {
     //   Criteria criteria=sessionFactory.getCurrentSession().createCriteria(DiaPatientNew.class);
    //    criteria.add(Restrictions.eq("patientId",patientId));
    //    return (DiaPatientNew) criteria.uniqueResult();
  //  }
}
