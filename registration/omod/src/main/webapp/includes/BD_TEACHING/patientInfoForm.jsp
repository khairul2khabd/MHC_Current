	...
	<center>
		<form id="patientInfoForm" method="POST">
			<table border=0 width="550">
				...
				<tr>
				<td colspan="1"><b>Sl No.<b></td>
				<td colspan="1">: &nbsp;&nbsp;<span style="font-size:25px; font-weight:bold;"> ${count}</span></td>
				</tr>
				<tr>
...
<center>
	...
	<input class="button" id="save" type="button" value="Save" onClick="PAGE.save();" />
</center>
<style>
    .button{
