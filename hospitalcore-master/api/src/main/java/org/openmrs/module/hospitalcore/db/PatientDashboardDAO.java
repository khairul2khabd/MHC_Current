...
public interface PatientDashboardDAO {
	...
	public List<InventoryDrug> findDrug(String name) throws DAOException;
        ...
        public OpddrugorderNew  saveDrugOrderOpdNew(OpddrugorderNew  drugTest) throws DAOException;
        
      //  public OpddrugorderNew getByEncounterId(Integer patientId,Integer encounterId) throws DAOException;
       }
