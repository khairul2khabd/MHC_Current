...
<form id="patientRegistrationForm" method="POST">
	<table cellspacing="0">
		<tr>
			<td valign="top" class="cell"><b>Name <span style="color: red">*</b></td>
			<td class="cell"><input id="patientName" name="patient.name"
				style="width: 300px;" /></td>
			<td class="cell"><b>ID Number <span style="color: red">* &nbsp;&nbsp; <input
					name="patient.identifier" style="border: none;" /> </b></td>
		</tr>
		<tr>
			<td class="cell"><b>Demographics <span style="color: red">*</b></td>
		...
		<tr>
			<td class="cell"><b>Relative Name <span style="color: red">*</b></td>
			<td class="cell">
