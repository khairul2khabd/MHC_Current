...
<script type="text/javascript">
    jQuery(document).ready(
            function() {
                ...
                jQuery("#countPatient").val(MODEL.countPatient);
...
<form id="patientRegistrationForm" method="POST" class="kha-aero">
    ...
    <table cellspacing="0">
        <tr>
            ...
            <td class="cell"><b>ID Number <span style="color:red;"> * </span> &nbsp;&nbsp; <input readonly name="patient.identifier" style="border: none; width: 250px; background:none;" /> </b>
            </td>
